    ...
    <br><br>
		...
		<form action="create.php" method="POST">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" name="pemilik_mobil" value="RIKA_1202204162" readonly>
			</div>
            <div class="mb-3">
			...
			<div class="mb-3">
				<div>
					<!-- <button href="detail.php" class="btn btn-primary" type="submit" value="simpan">Selesai</button> -->
                    <a type="submit" class="nav-link text-secondary"><a href="read.php" class="btn btn-primary " value="simpan">Selesai</a>
					<br>
				</div>
			</div>
		</form>
